...
var protossUnits = ["Probe", "Zealot", "Stalker", "Adept", "Archon", "Immortal", "Colossus", "Photon Cannon"]
var terranUnits = ["SCV", "Marine", "Marauder", "Reaper", "Ghost", "Hellion", "Hellbat", "Tank (Sieged)", "Tank (Unsieged)", "Thor", "Planetary Fortress"]
var zergUnits = ["Drone", "Zergling", "Baneling", "Roach", "Ravager", "Queen", "Hydralisk", "Lurker", "Ultralisk", "Spine Scrawler"]
